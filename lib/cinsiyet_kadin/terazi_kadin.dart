...
class terazi_kadin extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        resizeToAvoidBottomInset: false,
        appBar: AppBar(
          title: Text('TERAZİ KADINI'),
        ),
        body: terazii_kadin());
  }
}

class terazii_kadin extends StatefulWidget {
  @override
  _terazii_kadinState createState() => _terazii_kadinState();
}

class _terazii_kadinState extends State<terazii_kadin> {
  var gelenyazi="";
  Artboard _artboard;
  ...
  void _rivedosyasi() async {
    final terazidosya = await rootBundle.load('assets/terazikadın.riv');
  ...
  void _animasyon2() async {
    _artboard.addController(
      _animasyonkontrol2 = SimpleAnimation('terazikadın'),
    );
    setState(() => _animasyonkontrol2.isActive = true);
  }
  yazigetir() {
    FirebaseFirestore.instance.collection("burclar")
        .doc('terazikadın').get().then((gelen) {
      setState(() {
        gelenyazi = gelen.data()['terazikadın'];
      });
    }
    );
  }
